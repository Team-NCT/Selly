...
import ArtistRankingList from "./ArtistRankingList";

export default {
  title: "Home/ArtistRanking/ArtistRankingList",
  component: ArtistRankingList,
  parameters: {
    componentSubtitle: "아티스트 랭킹 아이템 리스트 컴포넌트",
  },
  argTypes: {},
} as Meta;
export const Default: Story<ArtistRankingListProps> = (args) => <ArtistRankingList {...args} />;
