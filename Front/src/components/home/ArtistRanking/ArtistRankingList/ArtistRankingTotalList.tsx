import { useFetchArtistTotalRankingDataQuery } from "@/api/server/userAPI";
import { Spinner } from "@/components/common";
import ArtistRankingItem from "../ArtistRankingItem/ArtistRankingItem";
import style from "./ArtistRankingList.module.scss";

const ArtistRankingTotalList = () => {
  const { data } = useFetchArtistTotalRankingDataQuery();
  console.log({ data });
  return (
    <>
      {!data ? (
...
export default ArtistRankingTotalList;
